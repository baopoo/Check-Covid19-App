  ...
  <div class="alert">
    ...
    <div class="alert-content d-flex flex-column align-items-center fs-normal fc-gray8">
      <template v-if="isSucces">
        ...
        <p 
          :style="'width: 250px; margin-bottom: 32px'" 
          class="text-center fw-400 text-normal fc-gray8"
        >
      ...
      <template v-else>
        ...
        <p 
          :style="'width: 302px; margin-bottom: 32px'" 
          class="text-center fw-400 text-normal fc-gray8"
        >
        ...
        <p 
          ...
          class="text-center fw-400 text-normal fc-gray9"
        >
